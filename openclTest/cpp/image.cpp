...
int main_image()
{
    ...
    /* Create Image Object */
    //image = clCreateImage2D(context, CL_MEM_READ_ONLY, &fmt, 4, 4, 0, 0, NULL); //CL1.1
	image = clCreateImage(context              /* context */,
    ...
    /* Retrieve result */
    ret =clEnqueueReadBuffer(command_queue, out, CL_TRUE, 0, sizeof(cl_float4)*num_out, result, 0, NULL, NULL);
